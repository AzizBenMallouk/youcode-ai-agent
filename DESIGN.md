...
colors:
  primary: "#c85a42" # Terracotta (Accent principal)
  primary-active: "#a6452f"
  primary-disabled: "#f2ece4"
  ink: "#2c2a29" # Brun très foncé / anthracite (Texte principal)
  body: "#4a4746"
  body-strong: "#1f1d1c"
  muted: "#8c8784" # Gris chaud (Texte secondaire)
  muted-soft: "#a6a19e"
  hairline: "#e8e4de" # Beige-gris léger (Bordures)
  hairline-soft: "#f0ece7"
  canvas: "#fcfbf9" # Crème très clair (Background principal)
  surface-soft: "#f7f5f0"
  surface-card: "#faf8f5" # Blanc chaud (Surface)
  surface-cream-strong: "#f0ece4"
  surface-dark: "#1a1918"
  surface-dark-elevated: "#2a2827"
  surface-dark-soft: "#242221"
  on-primary: "#ffffff"
  on-dark: "#fcfbf9"
  on-dark-soft: "#aba6a3"
  accent-teal: "#4f9e7b" # Vert YouCode discret (Accent secondaire)
  accent-amber: "#d99745" # Ambre (Avertissement)
  success: "#2e854b" # Vert accessible (Succès)
  warning: "#d99745"
  error: "#b83b3b" # Rouge sobre (Erreur)
