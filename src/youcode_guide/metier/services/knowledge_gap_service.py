...
from youcode_guide.metier.models.knowledge_gap_report_result import KnowledgeGapReportResult

from youcode_guide.metier.helpers.processor import (
    ProcessedQuestion,
    process_question,
)
...
class KnowledgeGapService:
    ...
    def report(
        ...
        *,
        ...
        try:
            ...
            semantic_match = (
                self.semantic_repository.find_similar(
                    question=(
                        processed
                        .sanitized_question
                    ),
            ...
            if semantic_match is not None:
                ...
                self.semantic_repository.delete(
    ...
    def _create_new_gap(
        ...
        *,
        ...
        try:
            self.semantic_repository.index_gap(
                gap,
                vector_point_id=vector_point_id,
            )
