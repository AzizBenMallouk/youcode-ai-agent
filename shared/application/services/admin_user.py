...
from shared.domain.enums.auth import UserRole
from shared.domain.exceptions import DuplicateEmailError
...
from shared.infrastructure.security.password import hash_password
