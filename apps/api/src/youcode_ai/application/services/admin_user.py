...
class AdminUserService:
    ...
    def create_user(self, *, email: str, password: str, full_name: str, role: str) -> UserTable:
    ...
    def list_users(self, *, page: int, page_size: int, role: str | None = None, is_active: bool | None = None) -> tuple[list[UserTable], int]:
        return self.user_repo.list_filtered(page=page, page_size=page_size, role=role, is_active=is_active)

    def update_user(self, *, user_id: str, full_name: str | None = None, role: str | None = None, is_active: bool | None = None) -> UserTable:
